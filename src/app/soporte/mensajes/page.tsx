      ...
      <div className="max-w-3xl mx-auto">
        ...
        {mensajesFiltrados.length === 0 ? (
          <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-8 text-center">
            <p className="text-zinc-400">{filtro === "no-leidos" ? "No hay mensajes sin leer." : "No hay mensajes recibidos."}</p>
          </div>
        ) : (
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-zinc-500">{msg.remitente_rol === "alumno" ? "👤 Alumno" : msg.remitente_rol === "profe" ? "👨‍🏫 Profesor" : "🛠️ Soporte"}</span>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-4">
            <div className="w-full max-w-lg bg-zinc-900 border border-zinc-800 rounded-2xl p-6 shadow-2xl">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div><span className="text-zinc-500">Rol:</span> <span className="text-white capitalize">{mensajeSeleccionado.remitente_rol || "—"}</span></div>
