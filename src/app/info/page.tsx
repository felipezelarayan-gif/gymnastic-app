    ...
    <main className="min-h-screen bg-[#0E0E0E] text-[#F0F0F0] overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0E0E0E]/80 backdrop-blur-xl border-b border-white/[0.07]">
        <div className="max-w-[1100px] mx-auto px-6 py-4 flex items-center justify-between">
          <a href="/info" className="flex items-center gap-2.5 no-underline">
            <svg
              width="20"
              height="20"
              viewBox="0 0 24 24"
      ...
      <section className="border-y border-white/[0.07]">
        <div className="max-w-[1100px] mx-auto grid grid-cols-3">
          {[
            { value: "✓", label: t("landing.stat1") },
            { value: "✓", label: t("landing.stat2") },
            { value: "✓", label: t("landing.stat3") },
          ].map((stat, i) => (
            <div
              key={i}
              className="p-8 sm:p-10 text-center border-r border-white/[0.07] last:border-r-0 hover:bg-[#161616] transition"
            >
              <div className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[#08A66C] tracking-tight mb-2">
                {stat.value}
              </div>
              <div className="text-xs sm:text-sm text-[#7a7a7a] font-normal">
                {stat.label}
              </div>
            </div>
          ))}
        ...
        <div className="max-w-[1100px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              {
                icon: "📋",
                title: t("landing.feature1Titulo"),
                desc: t("landing.feature1Desc"),
              },
              {
                icon: "📈",
                title: t("landing.feature2Titulo"),
                desc: t("landing.feature2Desc"),
              },
              {
                icon: "📏",
                title: t("landing.feature3Titulo"),
                desc: t("landing.feature3Desc"),
              },
              {
                icon: "🏋️",
                title: t("landing.feature4Titulo"),
                desc: t("landing.feature4Desc"),
              },
              {
                icon: "👥",
                title: t("landing.feature5Titulo"),
                desc: t("landing.feature5Desc"),
              },
              {
                icon: "💬",
                title: t("landing.feature6Titulo"),
      ...
      {/* ─── SERVICIO ─── */}
      <section className="py-16 sm:py-20 px-6 bg-[#161616]">
        <div className="max-w-[800px] mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              <div
                key={i}
                className="bg-[#1E1E1E] border border-white/[0.07] rounded-xl p-6 text-left"
              >
      ...
      {/* ─── CONTACTO ─── */}
      <section id="contacto" className="py-16 sm:py-20 px-6">
