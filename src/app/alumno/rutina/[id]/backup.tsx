...
export default function AlumnoRutinaPage() {
  ...
  async function cargarTodo() {
    ...
    // Obtener nombre del alumno desde profiles
  ...
  async function guardarCompletado() {
    ...
    if (!esAvanzado && (!seriesRealizadas[1]?.peso || !seriesRealizadas[1]?.repeticiones)) {
  ...
  return (
    <main className="min-h-screen bg-zinc-950 text-white pb-24">
      <div className="max-w-2xl mx-auto px-4 pt-8">
        ...
        {/* Header */}
        <div className="mb-8">
          <p className="text-zinc-500 text-sm capitalize mb-1">{fechaHoy}</p>
          <h1 className="text-3xl font-bold tracking-tight">
            {modoModificar ? "✏️ Modificando entrenamiento" : "Entrenamiento de hoy"}
          </h1>
          {nombreAlumno && (
      ...
      <CompletarEjercicioModal
        ...
        seriesAvanzadas={
          ejercicioSeleccionado
            ? seriesPorEjercicio[ejercicioSeleccionado.id] || []
            : []
        }
